...
<<<<<<< HEAD
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5 tm-about-right">
                        <div class="tm-img-container margin-bottom-30">
                            <div class="tm-img-overlay">
                                <p class="img-description">{{$about['title']}}</p>
                                <p class="img-title">{{$about->description}}</p>
                            </div>
                            <img src="{{($about->image)}}" alt="Image" class="img-responsive">                                               
                    </div>
                </div>
                @endforeach
            </div>
            ...
            <div class="container">
                ...
                @foreach($whos as $who)
                    <div class="col-lg-4 col-md-4 col-sm-4 text-center tm-about-container-2">
                        <img src="{{($who->image)}}" alt="Image">
                        <h3 class="text-uppercase about-h3">{{$who['title']}}</h3>
                        <p class="about-description">{{$who->description}}</p>
                    </div>                  
                    @endforeach
                </div>
            </div>
        ...
        <section class="templatemo-container">
            ...
            <h3 class="text-uppercase recent-post-title margin-bottom-30"><span class="font-weight-700">{{$post['firsttitle']}}</span> <span class="font-weight-300 blue-text">{{$post['lasttitle']}}</span></h3>
            <img src="{{($post->image)}}" alt="Image" class="img-responsive margin-bottom-30">
            <p class="justify-text"><span class="red-text">{{$post['title']}}</span>{{$post->description}}</p>           
            </div>
                </div>
            @endforeach
            </div>
